    ...
    public static class VbaGen
    {
        ...
        private static string[] CoreLines()
        {
            return new string[]
            {
                ...
                "                If (Len(className) = 0 Or " + CodeModules.RuntimeLocator + ".ClassOf(child) = className) And (Len(title) = 0 Or " + CodeModules.RuntimeLocator + ".TitleOf(child) = title) Then",
                "                    matches = matches + 1",
                ...
                "    End If",
                "    If state = \"done\" Then",
                "        MsgBox \"The recorded procedure finished.\", vbOKOnly + vbInformation, \"" + CodeModules.Workflow + "\"",
                "    Else",
                "        MsgBox detail, vbOKOnly + vbExclamation, \"" + CodeModules.Workflow + "\"",
                "    End If",
                "End Sub",
                ""
            };
